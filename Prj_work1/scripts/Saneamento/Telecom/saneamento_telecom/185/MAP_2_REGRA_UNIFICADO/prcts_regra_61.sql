-- CREATE OR REPLACE 
PROCEDURE prcts_regra_61(p_inf         IN OUT NOCOPY c_inf%rowtype)
AS
BEGIN
    IF
        ...
        AND (p_inf.ESTB_COD IN ('40','41') AND NVL(p_inf.INFST_ALIQ_ICMS,0) != 0)

	THEN
      p_inf.update_reg         := 1;
      p_inf.var05              := SUBSTR('prcts_regra_61:' || p_inf.INFST_ALIQ_ICMS  || '>>' ||p_inf.var05,1,150);
