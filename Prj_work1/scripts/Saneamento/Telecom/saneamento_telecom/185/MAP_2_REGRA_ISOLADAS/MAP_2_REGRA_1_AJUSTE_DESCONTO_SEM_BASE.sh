...
var v_msg_erro            VARCHAR2(4000) = 'MAP_2_REGRA_1_AJUSTE_DESCONTO_SEM_BASE'
...
PROMPT
PROMPT MAP_2_REGRA_1_AJUSTE_DESCONTO_SEM_BASE
...
BEGIN
   ...
   LOOP
      ...
      UPDATE openrisow.item_nftl_serv partition (${PARTICAO_INF}) inf
        SET inf.VAR05                = SUBSTR('r2015_1:' || inf.infst_outras_icms || '|' || inf.infst_val_desc || '|' || inf.infst_val_serv|| '|' || inf.infst_val_cont || '>>'|| inf.VAR05,1,150)
