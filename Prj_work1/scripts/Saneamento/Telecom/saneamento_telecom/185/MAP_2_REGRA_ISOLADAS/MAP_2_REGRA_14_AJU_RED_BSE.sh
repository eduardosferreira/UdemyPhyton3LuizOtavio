...
var v_msg_erro            VARCHAR2(4000) = 'MAP_2_REGRA_14_AJU_RED_BSE'
...
PROMPT
PROMPT MAP_2_REGRA_14_AJU_RED_BSE
...
BEGIN
   ...
   LOOP
	...
	IF v_item_nftl_serv.update_reg     = 1 THEN
        ...
        v_inf.update_reg           			  := 1;
	    v_inf.VAR05                           := SUBSTR('r2015_14u:' || v_inf.INFST_OUTRAS_ICMS || '|' || v_inf.infst_val_cont || '|' || v_inf.INFST_VAL_SERV || '>>'|| v_inf.VAR05,1,150);
