...
GROUP BY EMPS_COD, MES_ANO,  SERIE,  CFOP, AREA, ORIGINAL
    ...
    queryR = """
        SELECT /*+ parallel(tmp,8), index(tmp ITEM_NFTL_SERVI2) */
            ...
            trim(replace(tmp.INFST_SERIE,' ',''))        as serie,
            tmp.CFOP,
...
#### ALT007 - Inicio
    ...
    dir_base = os.path.join(configuracoes.dir_geracao_arquivos.split('Insumos')[0], 'Insumos', 'SPED_FISCAL')
