-- CREATE OR REPLACE 
PROCEDURE prcts_regra_1(p_inf         IN OUT NOCOPY c_inf%rowtype)
AS
...
BEGIN
  ...
  THEN
	...
	THEN
      p_inf.update_reg         := 1;
      p_inf.var05                                                                := SUBSTR('prcts_regra_1:' || p_inf.infst_outras_icms || '|' || p_inf.infst_val_desc || '|' || p_inf.infst_val_serv || '|' || p_inf.infst_val_cont || '>>' ||p_inf.var05,1,150);
