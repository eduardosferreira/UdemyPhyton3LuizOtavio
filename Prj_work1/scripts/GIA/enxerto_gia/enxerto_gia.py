...
#### Recebe, verifica e formata os argumentos de entrada.
    ...
    dir_dados        = configuracoes.diretorio_arquivos.replace("<<uf>>",ufi)+SD
    dir_protocolados = os.path.join(dir_dados.split('enxerto_gia')[-1], 'PROTOCOLADOS')
    dir_regerados    = os.path.join(dir_dados.split('enxerto_gia')[-1], 'REGERADOS')  
                                        ...
                                        for iee in listadeies:
                                            if ((iee == iei) or (iei == "*")):
                                                ...
                                                if (os.path.isfile(nome_protocolado)):
                                                    ...
                                                    path_regerados = path_final.replace("PROTOCOLADOS", "REGERADOS") 
                                                    ...
                                                    if (os.path.isfile(nome_regerado)):
                                                        ...
                                                        denx = os.path.join(dir_dados, 'ENXERTADOS',str(dir_ano),str(dir_mes))
