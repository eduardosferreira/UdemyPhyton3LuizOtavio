...
def leDadosArquivosControle() :
    dir_base_obrigacoes = configuracoes.dir_base_obrigacoes
...
def gerarNovosArquivos() :
    ...
    dir_ready = os.path.join( getattr(configuracoes,'pasta_trabalho', '.'), 'ready', id_serie )
    dir_work = os.path.join(  getattr(configuracoes,'pasta_trabalho', '.'), 'work', id_serie )
